Run outputs for epistack_eval.py (combined, v6 - 4 cases; covid_large adds the Part C retracted-claim test).
...
correctly discounted the withdrawn claim.
  ...
  ----------------------------
  mean       0.00     -0.012
  mean_retraction_ignored_effect: Opus ~0.048, Sonnet ~0.040
